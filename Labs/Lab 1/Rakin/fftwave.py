...
def fftwave(u, v, sz = 128):
	"""
	Displays the Fourier transform of a 2D image with a single wave component.
	
	Parameters:
	u (int): The horizontal frequency of the wave component.
	v (int): The vertical frequency of the wave component.
	sz (int): The size of the 2D image. Default is 128.
	"""
	Fhat = np.zeros([sz, sz])
	Fhat[u, v] = 1
	...
	wavelength = 1/np.sqrt(uc**2 + vc**2) # Lecture three
